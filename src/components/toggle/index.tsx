...
export const Toggle: FC<ToggleProps> = (props) => {
  ...
  const toggleBoxClassList = `relative w-[64px] border-2 border-primary-600 h-7 rounded-lg cursor-pointer focus:outline-white ${isEnabled ? "border-primary-600" : "border-secondary-500"}`
